...
import { LinkedInSettings } from 'types';
...
interface SettingsFormProps {
  ...
  onSave: (
    val: LinkedInSettings | ((prevState: LinkedInSettings) => LinkedInSettings)
  ) => void;
}
...
export default function SettingsForm({ settings, onSave }: SettingsFormProps) {
  ...
  const form = useForm<FormState>({
    initialValues: {
      ...
      currentKeyword: '',
      postsPerKeyword: settings.postsPerKeyword,
          ...
          <form>
            ...
            <Box>
              <Group position="apart">
                <TextInput
                  ...
                  placeholder="Posts to fetch per keyword"
                  {...form.getInputProps('postsPerKeyword')}
                />
              </Group>
            </Box>
            ...
            <Box>
              <Group position="apart">
                <TextInput
                  sx={{ width: '100%' }}
                  label="LinkedIn session id"
                  placeholder="session id (`li_at` cookie)"
            ...
            <Button
              ...
              onClick={() =>
                onSave({
                  ...
                  postsPerKeyword: form.values.postsPerKeyword,
